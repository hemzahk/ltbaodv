...
#ifndef TRUSTAODV_TRUSTAODV_H_
#define TRUSTAODV_TRUSTAODV_H_
...
class INET_API TrustAodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
    protected:
    /*
